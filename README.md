...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-hookman-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6144&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-hookman-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-hookman` can be installed with:

```
conda install python-hookman
```

It is possible to list all of the versions of `python-hookman` available on your platform with:
